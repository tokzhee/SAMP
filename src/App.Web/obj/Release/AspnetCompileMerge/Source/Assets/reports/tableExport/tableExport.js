...
(function ($) {
  $.fn.tableExport = function (options) {
    var defaults = {
      ...
      fileName:            'Digital Lending Platform Exported Data',
      htmlContent:         true,
      ignoreColumn:        [],
      ignoreRow:           [],
      ...
      jspdf: {                          // jsPDF / jsPDF-AutoTable related options
        ...
        autotable: {
          styles: {
            ...
            fontStyle:     'book antiqua',    // normal, bold, italic, bolditalic or 'inherit' to use css font-weight and fonst-style from html table
